#define MS_CLASS "RTC::TransportLoopback"
// #define MS_LOG_DEV
...
namespace RTC
{
	...
	TransportLoopback::TransportLoopback(
	  Listener* listener, Channel::Notifier* notifier, uint32_t transportId)
	...
	void TransportLoopback::Destroy()
	{
		MS_TRACE();
	...
	void TransportLoopback::StartMirroring(MirroringOptions& options)
	{
		MS_TRACE();
		...
		switch (Utils::IP::GetFamily(options.remoteIP))
		{
			case AF_INET:
			{
				...
				this->mirrorSocket = new RTC::UdpSocketLoopback(this, AF_INET);
			...
			case AF_INET6:
			{
				...
				this->mirrorSocket = new RTC::UdpSocketLoopback(this, AF_INET6);
	...
	void TransportLoopback::StopMirroring()
	{
	...
	void TransportLoopback::HandleProducer(RTC::Producer* producer)
	{
		MS_TRACE();
	...
	void TransportLoopback::HandleConsumer(RTC::Consumer* consumer)
	{
		MS_TRACE();
	...
	void TransportLoopback::HandleRtcpPacket(RTC::RTCP::Packet* packet)
	{
		MS_TRACE();
	...
	void TransportLoopback::SendRtcp(uint64_t now)
	{
		MS_TRACE();
	...
	inline RTC::Consumer* TransportLoopback::GetConsumer(uint32_t ssrc) const
	{
		MS_TRACE();
	...
	void TransportLoopback::OnProducerClosed(RTC::Producer* producer)
	{
		MS_TRACE();
	...
	void TransportLoopback::OnProducerRtpParametersUpdated(RTC::Producer* producer)
	{
		MS_TRACE();
	...
	void TransportLoopback::OnProducerPaused(RTC::Producer* /*producer*/)
	{
		// Do nothing.
	}

	void TransportLoopback::OnProducerResumed(RTC::Producer* /*producer*/)
	{
		// Do nothing.
	}

	void TransportLoopback::OnProducerRtpPacket(
	...
	void TransportLoopback::OnProducerProfileEnabled(
	  RTC::Producer* /*producer*/,
	  RTC::RtpEncodingParameters::Profile /*profile*/,
	...
	void TransportLoopback::OnProducerProfileDisabled(
	  RTC::Producer* /*producer*/, RTC::RtpEncodingParameters::Profile /*profile*/)
	{
		// Do nothing.
	}

	void TransportLoopback::OnConsumerClosed(RTC::Consumer* consumer)
	{
		MS_TRACE();
	...
	void TransportLoopback::OnConsumerKeyFrameRequired(RTC::Consumer* /*consumer*/)
	{
		// Do nothing.
	}

	void TransportLoopback::OnTimer(Timer* timer)
	{
	...
	void TransportLoopback::OnPacketRecv(
