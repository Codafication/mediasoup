...
namespace RTC
{
	...
	class TransportLoopback : public RTC::ProducerListener,
	                          public RTC::ConsumerListener,
	                          public Timer::Listener,
	                          public RTC::UdpSocketLoopback::Listener
	{
	public:
		class Listener
		{
		public:
			virtual void OnTransportClosed(RTC::TransportLoopback* transport) = 0;
			virtual void OnTransportReceiveRtcpFeedback(
			  RTC::TransportLoopback* transport,
			  RTC::Consumer* consumer,
			  RTC::RTCP::FeedbackPsPacket* packet) = 0;
		};
	...
	public:
		TransportLoopback(Listener* listener, Channel::Notifier* notifier, uint32_t transportId);

	protected:
		virtual ~TransportLoopback();
	...
	public:
		...
		/* Pure virtual methods inherited from UdpSocketLoopback::Listener. Mirroring. */
	public:
		void OnPacketRecv(
	...
	protected:
		...
		// Allocated (Mirroring).
		RTC::UdpSocketLoopback* mirrorSocket{ nullptr };
